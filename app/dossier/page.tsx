            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                >
                    <div className="w-24 h-24 rounded-full bg-zinc-800 border border-white/10 mb-5 flex items-center justify-center grayscale overflow-hidden group-hover:border-zinc-500 transition-colors duration-500">
                        <User className="w-10 h-10 text-zinc-500" strokeWidth={1} />
                    </div>
                ...
                {/* Bottom Box 1: Education */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                    transition={{ duration: 0.8, delay: 0.3 }}
                    className="bg-zinc-900/40 backdrop-blur-xl border border-white/5 rounded-2xl p-6 shadow-xl"
                >
                ...
                >
                    ...
                    <ul className="space-y-4">
                        <li>
                            ...
                            <p className="text-xs text-zinc-500 mt-1">Journal of Geopolitics · 2024</p>
                        </li>
                        <li>
                            <p className="text-sm text-zinc-200 font-medium leading-snug">Overland Redundancy in the Middle East</p>
                            <p className="text-xs text-zinc-500 mt-1">Global Trade Review · 2023</p>
                        </li>
                    </ul>
                </motion.div>

                {/* Bottom Box 3: Research Focus */}
                <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                ...
                >
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="text-sm font-medium text-zinc-300">Research Focus</h3>
                    </div>
                    <div className="flex flex-wrap gap-2">
                        {['Supply Chain Resilience', 'Neoclassical Realism', 'Suez Bypasses', 'Blue-Raman Digital Architecture', 'G20 Infrastructure'].map((tag) => (
                            <span key={tag} className="px-2.5 py-1 bg-white/5 border border-white/5 rounded-md text-[11px] text-zinc-400 font-light">
                                {tag}
                            </span>
                        ))}
                    </div>
